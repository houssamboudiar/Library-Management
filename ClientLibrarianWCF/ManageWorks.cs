...
[System.ServiceModel.ServiceContractAttribute(ConfigurationName="IManageWorks")]
public interface IManageWorks
{
    ...
    bool AddWork(string[] tags, string[] writers, string title, string theme, string type);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IManageWorks/AddWork", ReplyAction="http://tempuri.org/IManageWorks/AddWorkResponse")]
    System.Threading.Tasks.Task<bool> AddWorkAsync(string[] tags, string[] writers, string title, string theme, string type);
    ...
    bool EditWork(int idWork, string[] tags, string[] writers, string title, string theme, string type);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IManageWorks/EditWork", ReplyAction="http://tempuri.org/IManageWorks/EditWorkResponse")]
    System.Threading.Tasks.Task<bool> EditWorkAsync(int idWork, string[] tags, string[] writers, string title, string theme, string type);
...
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public interface IManageWorksChannel : IManageWorks, System.ServiceModel.IClientChannel
{
}

[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public partial class ManageWorksClient : System.ServiceModel.ClientBase<IManageWorks>, IManageWorks
{
    ...
    public bool AddWork(string[] tags, string[] writers, string title, string theme, string type)
    {
        return base.Channel.AddWork(tags, writers, title, theme, type);
    }
    
    public System.Threading.Tasks.Task<bool> AddWorkAsync(string[] tags, string[] writers, string title, string theme, string type)
    {
        return base.Channel.AddWorkAsync(tags, writers, title, theme, type);
    }
    
    public bool EditWork(int idWork, string[] tags, string[] writers, string title, string theme, string type)
    {
        return base.Channel.EditWork(idWork, tags, writers, title, theme, type);
    }
    
    public System.Threading.Tasks.Task<bool> EditWorkAsync(int idWork, string[] tags, string[] writers, string title, string theme, string type)
    {
